...
3. Write the plan into a markdown file in the `todo` folder.
4. At the top of the file, insert a todo-list with the phases
   or steps that you have defined, and format the list in terms
   of check-box items.
